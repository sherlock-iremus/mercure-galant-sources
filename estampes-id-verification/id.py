...
for x in inbd:
    if x not in id_articles_transcrits:
        print(f"L'id « {x} » lu dans la colonne A ne correspond pas à un article transcrit (https://github.com/sherlock-iremus/mercure-galant-sources-sherlock/tree/main/tei/articles)")
